...
{ 
  ...
  //pid.setpoint(30); // the goal angle 
...
{ 
    ...
    Serial.print("encoder_count = "); //ספירת מספר הפולסים
    ...
    motor_pwm_value = pid.compute(tick_to_deg1); //compute the PWM value for calculate direction 
    ...
    delay(50); Serial.print("tick_to_deg1 = "); 
